...
export default function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Did a CRUD operation project using MySQL and phpMyAdmin for database management.",
    ...
    },
    {
      ...
      description:
        "beginner level python programs for entry level programmers.",
      tools: ["Python"],
      results:
        "Enhanced understanding of Python programming and its applications",
      link: "#",
    ...
    },
    {
      ...
      description:
        "just in case someone wants to see the code behind this portfolio website or wants to make a similar one.",
      tools: ["React", "Tailwind CSS"],
      results:
        "Well-structured and visually appealing portfolio website, simplistic and aesthetic design",
      link: "#",
    ...
    },
    {
      ...
      description:
        "A movie site clone built using React and Tailwind CSS, showcasing a visually appealing and responsive design.",
      tools: ["React", "Tailwind CSS"],
      results:
        "A visually appealing and responsive movie site clone, demonstrating proficiency in React and Tailwind CSS.Also u cant watch movies there but u can watch trailer(Cuz its illegal)",
      ...
      >
        <div className="text-center animate-fadeIn">
          <div className="relative w-20 h-20 mx-auto mb-4">
            <div
              className={`absolute inset-0 rounded-full border-4 border-t-blue-600 animate-spin ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}
            ></div>
          </div>
          <p
  ...
  return (
    ...
    >
      {/* Navigation */}
      <nav
        className={`fixed top-0 w-full z-50 transition-all duration-300 ${isDarkMode ? "bg-gray-800/95" : "bg-white/95"} backdrop-blur-sm shadow-sm`}
      >
      ...
      <section
        id="home"
        className={`min-h-screen flex items-center justify-center px-4 pt-16 ${visibleSections.has("home") ? "" : ""}`}
      >
        <div className="max-w-4xl mx-auto text-center">
          <h1
            className={`text-5xl md:text-7xl font-bold mb-6 ${visibleSections.has("home") ? "animate-fadeInUp" : "opacity-0"}`}
          >
            <span className="gradient-text">Ashwin Thapa</span>
          </h1>
          <p
            className={`text-xl md:text-2xl mb-4 h-8 ${isDarkMode ? "text-gray-300" : "text-gray-600"} ${visibleSections.has("home") ? "animate-fadeInUp animate-delay-200" : "opacity-0"}`}
          >
            <span className="typing-cursor">{typedText}</span>
          </p>
          <p
            className={`text-lg mb-8 max-w-2xl mx-auto ${isDarkMode ? "text-gray-400" : "text-gray-500"} ${visibleSections.has("home") ? "animate-fadeInUp animate-delay-300" : "opacity-0"}`}
          >
          ...
          <div
            className={`flex flex-col sm:flex-row gap-4 justify-center ${visibleSections.has("home") ? "animate-fadeInUp animate-delay-400" : "opacity-0"}`}
          >
            <a
              href="/portfolio.pdf"
              download
      ...
      >
        <div className="max-w-6xl mx-auto">
          <h2
            className={`text-4xl font-bold mb-12 text-center ${visibleSections.has("about") ? "animate-fadeInUp" : "opacity-0"}`}
          >
            About Me
          </h2>
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              >
                I am just a kid learning to build years of experience building
                scalable web applications. Always a yearner and I yearn for
                improvement. Committed to writing clean, maintainable code and
            ...
            >
              ...
              <div className="space-y-4">
                <div
                  className={`p-4 rounded-lg transition-all duration-300 ${isDarkMode ? "bg-gray-700/50 hover:bg-gray-700" : "bg-white hover:shadow-md"}`}
                >
                  ...
                  <p className={isDarkMode ? "text-gray-400" : "text-gray-600"}>
                    Currently Pursuing, Asian School of Management and
                    Technology
                  </p>
                </div>
              </div>
          ...
          <div
            className={`mt-12 ${visibleSections.has("about") ? "animate-fadeInUp animate-delay-300" : "opacity-0"}`}
          >
            ...
            >
              Seeking opportunities to leverage my expertise in full-stack
              development to build innovative products that solve real-world
              problems. Passionate about mentoring, continuous learning, and
      ...
      <section id="experience" className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <h2
            className={`text-4xl font-bold mb-12 text-center ${visibleSections.has("experience") ? "animate-fadeInUp" : "opacity-0"}`}
          >
            Experience & Skills
          </h2>
          ...
          <div className="mb-16">
            <h3
              className={`text-2xl font-semibold mb-8 ${visibleSections.has("experience") ? "animate-fadeInUp" : "opacity-0"}`}
            >
              Work Experience
            </h3>
            <div className="space-y-8">
              {experiences.map((exp, index) => (
                ...
                >
                  ...
                  <p
                    className={`font-medium mb-2 ${isDarkMode ? "text-blue-400" : "text-blue-600"}`}
                  >
                    {exp.company}
                  </p>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <h2
            className={`text-4xl font-bold mb-12 text-center ${visibleSections.has("projects") ? "animate-fadeInUp" : "opacity-0"}`}
          >
            Featured Projects
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              ...
              >
                ...
                <p
                  className={`text-sm mb-4 font-medium ${isDarkMode ? "text-blue-400" : "text-blue-600"}`}
                >
                  {project.results}
                </p>
      ...
      <section id="contact" className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <h2
            className={`text-4xl font-bold mb-12 text-center ${visibleSections.has("contact") ? "animate-fadeInUp" : "opacity-0"}`}
          >
            Get In Touch
          </h2>
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              <form onSubmit={handleSubmit}>
                <div className="space-y-4">
                  ...
                  {formStatus === "success" && (
                    <p className="text-green-500 text-center animate-fadeIn">
      ...
      {/* Footer */}
      <footer
        className={`py-8 px-4 text-center ${isDarkMode ? "bg-gray-800 border-t border-gray-700" : "bg-gray-50 border-t border-gray-200"}`}
      >
        <p
